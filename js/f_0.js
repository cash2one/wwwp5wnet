...
function zhenfuOne() {
    $.getJSON("http://data.p5w.net/yb/p5wstock.php?m=summaryab&count=5&callback=?", function (data) {
        if (data.szsh.A != null) {
            var html = new Array();
            html.push('<ul>');
            var g = data.szsh.A.zhenfu || [];
            $(g).each(function (i) {
                if (i < 5) {
...
function jigouguanzhu() {
    $.getJSON("http://data.p5w.net/yb/p5wstock.php?m=hotstock&count=5&callback=?", function (data) {
        if (data.hotstocks != null) {
            ...
            $(g).each(function (i) {
                if (i < 5) {
                    html.push('<li class="lh4 blue"><a href="' + hqUrl + this.s3 + this.s1 + '" target="_blank">' + this.s2 + '</a></li><li class="lh5">' + this.s11 + '</li><li class="lh6">' + this.s10 + '</li><li class="lh7">' + this.s12 + '</li>');
                }
            });
            html.push('</ul>');
