    ...
    switch (path) {
        case "全景快讯":
            Base.loadJs('http://www.p5w.net/kuaixun/tj/lmlj/channelNav.js', function () {
                $('#channelNav').html(channelNavLinks.join(' | '));
            }, 'gb2312');
            break;
        case "全景快讯0":
            Base.loadJs('http://www.p5w.net/kuaixun/tj/lmlj/channelNav.js', function () {
            ...
            break;
        case "股票频道":
            Base.loadJs('http://www.p5w.net/stock/tj/zqsylj/channelNav.js', function () {
                $('#channelNav').html(channelNavLinks.join(' | '));
            }, 'gb2312');
            break;
        case "基金频道":
            Base.loadJs('http://www.p5w.net/fund/jjtj/lmlj/channelNav.js', function () {
                $('#channelNav').html(channelNavLinks.join(' | '));
            }, 'gb2312');
            break;
        case "新闻频道":
            Base.loadJs('http://www.p5w.net/news/xwtj/lmlj/channelNav.js', function () {
                $('#channelNav').html(channelNavLinks.join(' | '));
            }, 'gb2312');
            break;
        case "理财频道":
            Base.loadJs('http://www.p5w.net/money/tj/lmlj/channelNav.js', function () {
                $('#channelNav').html(channelNavLinks.join(' | '));
            }, 'gb2312');
            break;
        case "外汇频道":
            Base.loadJs('http://www.p5w.net/forex/tj/nav/channelNav.js', function () {
                $('#channelNav').html(channelNavLinks.join(' | '));
            }, 'gb2312');
            break;
        case "期货频道":
            Base.loadJs('http://www.p5w.net/futures/tj/nav/channelNav.js', function () {
                $('#channelNav').html(channelNavLinks.join(' | '));
            }, 'gb2312');
            break;
        default:
