...
var videoGensee = function () {
    ...
    if (!(vodCode == '' || vodCode == null || vodCode == undefined)) {
        var videoHtml = '<gs:video-vod site="jcsx.gensee.com" ctx="webcast" ownerid="' + vodCode + '" py="1" bar="true"/>';
        $('#videoGensee').addClass('videoDiv').html(videoHtml);
        return;
    }
    if (!(liveCode == '' || liveCode == null || liveCode == undefined)) {
        var videoHtml = '<gs:video-live site="jcsx.gensee.com" ctx="webcast" ownerid="' + liveCode + '" py="1" bar="false"/>';
        $('#videoGensee').addClass('videoDiv').html(videoHtml);
        return;
    }
}