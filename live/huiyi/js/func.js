...
var shareButton = function () {
    document.writeln('<a class="bshareDiv" href="http://www.bshare.cn/share">����</a>');
...
var goToTop = function () {
    var html = '<div class="gototop-wrap"><div id="gototop_btn" class="gototop"><a style="display:none;" title="���ض���" href="javascript:void(0);" onfocus="this.blur();" class="toplink">TOP</a></div></div>';
    var win = $(window);
